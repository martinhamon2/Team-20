...
export default function Footer() {
  return (
    <footer className="mt-8 border-t border-blue-200 px-4 py-3">
      <div className="mx-auto flex max-w-[1200px] flex-col justify-between gap-2 md:flex-row md:px-2.5">
        <div className="flex flex-col justify-center gap-2 md:flex-row">
          <a href="https://www.kuleuven.be/kuleuven" title="KU Leuven">
            <Image
              alt="logo"
          ...
          <ul className="items-center md:flex">
            <li className="border-[#d8d9da] md:ml-2.5 md:border-l md:pl-2.5">
              <a
                href="https://www.kuleuven.be/kuleuven/disclaimer.html"
            ...
            <li className="border-[#d8d9da] md:ml-2.5 md:border-l md:pl-2.5">
              <a
                href="https://admin.kuleuven.be/icts/cookiebeleid/"
                className="text-primary underline hover:no-underline"
              >
                Cookie settings
              </a>
            ...
            <li className="border-[#d8d9da] md:ml-2.5 md:border-l md:pl-2.5">
              <a
                href="https://admin.kuleuven.be/privacy/"
                className="text-primary underline hover:no-underline"
              >
                Privacy Policy
              </a>
            ...
            <li className="border-[#d8d9da] md:ml-2.5 md:border-l md:pl-2.5">
              <a
                href="https://www.kuleuven.be/personeel/jobsite?source=CorporateFooter"
                className="text-primary underline hover:no-underline"
              >
                Jobs
              </a>
        ...
        <div className="text-primary items-center gap-2 sm:flex">
          <span className="text-sm">Follow KU&nbsp;Leuven on</span>
